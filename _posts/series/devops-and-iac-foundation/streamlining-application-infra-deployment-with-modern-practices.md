...
description: "Why GitOps/DevOps and Infrastructure as Code (IaC) Matter. Part of the 'DevOps and IaC Foundation' series."
mermaid: true
---
...
### Use Case: Modernizing Application Infra Deployment Practices with GitOps/DevOps and Infrastructure as Code (IaC)
...
![GitOps Workflow](/assets/series/devops-and-iac-foundation/images/gitOps_workflow.png)
...
#### 3.1.1 Infrastructure as Code (IaC) Compliance
...
#### 3.1.2 Tool Standardization and Integration
...
#### 3.1.3 Modular and Scalable Repository Structure
...
#### 3.1.4 Continuous Compliance and Security Scanning
...
#### 3.1.5 Cost Estimation and Optimization
...
#### 3.1.6 Webhook-Based Automation for GitOps
...
#### 3.1.7 Policy Enforcement and Idempotent Operations
...
#### 3.2.3 Define Repository Structure
...
#### 3.2.4 Implement Continuous Compliance
...
#### 3.2.8 Documentation and Training
...
## 5. Checklist for Foundation Setup
...
### 5.2 Unified Resuable DevOps Pipeline Templates 
...
4. **Stage Templates:**
   ...
   **Example:** A stage template for a CI/CD pipeline might include jobs for building, testing, and deploying an application (e.g., AKS), ensuring that each stage is logically structured and executed in the correct sequence.
...
### 5.2.4 How to Leverage These Unified Template in Your CICD Flow
...
## 5.3  Infra as Code Repository Setup 
