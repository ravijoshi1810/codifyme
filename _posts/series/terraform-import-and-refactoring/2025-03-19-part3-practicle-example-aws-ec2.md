---
title: "3. Practical Example: AWS EC2 Import"
layout: post
author: Ravi Joshi
...
![Python Script](/assets/series/terraform-import-and-refactoring/images/post3-tf_import_script.png)
...
![Directory Structure](/assets/series/terraform-import-and-refactoring/images/post3_tf_import_directory_structure.png)
...
![Generated Files](/assets/series/terraform-import-and-refactoring/images/post3_tf_import_generated_files.png)
...
-   ✅ Ensure that only the import count has changed in the plan output and no other changes are present.
    ...
    ![Plan Output](/assets/series/terraform-import-and-refactoring/images/post3_tf_import_plan_output.png)
...
![terraform apply output](/assets/series/terraform-import-and-refactoring/images/post3_tf_import_local_apply_output.png)
...
![copy_files](/assets/series/terraform-import-and-refactoring/images/post3_tf_import_copy_files.png)
...
- 🔑 Login to TFE by running this command `terraform login yourtfe-url` and provide the token.
  ...
  ![post3_tflogin](/assets/series/terraform-import-and-refactoring/images/post3_tflogin.png)
...
- 🚀 Run the following command to initialize the Terraform working directory:
  ...
  ![terraform init](/assets/series/terraform-import-and-refactoring/images/post3_tfinit.png)
...
- Run the following command to generate an execution plan:
  ...
  ![terraform plan](/assets/series/terraform-import-and-refactoring/images/post3_tf_remote_plan1.png)
...
- Review the plan output to ensure that only the import count has changed and no other changes are present.
  ...
  ![terraform plan](/assets/series/terraform-import-and-refactoring/images/post3_tf_remote_plan2.png)
...
- If everything looks good, run the following command to apply the changes:
  ...
  ![terraform apply](/assets/series/terraform-import-and-refactoring/images/post3_import_status_post_apply.png)
